...
const paths = {
  ...
  linkedin: (
    <>
      <path
        d="M6.7 9.2H3.8V20h2.9zM5.2 7.7a1.8 1.8 0 1 0 0-3.6 1.8 1.8 0 0 0 0 3.6Z"
        fill="currentColor"
        stroke="none"
      />
      <path
        d="M20.2 20v-5.9c0-3.2-1.7-4.7-4-4.7a3.4 3.4 0 0 0-3.1 1.7V9.2h-2.8V20h2.9v-5.4c0-1.4.3-2.8 2-2.8s1.8 1.6 1.8 2.9V20z"
        fill="currentColor"
        stroke="none"
      />
    </>
